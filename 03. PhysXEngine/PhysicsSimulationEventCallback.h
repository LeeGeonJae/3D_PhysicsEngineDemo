...
namespace physics
{
	...
	public:
		...
		inline void SetCallbackFunction(std::function<void(physics::CollisionData, physics::ECollisionEventType)> func);

	private:
		std::function<void(physics::CollisionData, physics::ECollisionEventType)> mFunction;
	};

	void PhysicsSimulationEventCallback::SetCallbackFunction(std::function<void(physics::CollisionData, physics::ECollisionEventType)> func)
	{
		mFunction = func;
	}
}